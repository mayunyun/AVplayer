...
- (void)buildVideoNavBar
{
    ...
    _showView.autoresizingMask = UIViewAutoresizingNone;
...
//        self.view.transform = CGAffineTransformIdentity;
    ...
    {
        [self.showView.window changeFrame:interfaceOrientation];
    }
...
{
    NSLog(@"did rotated to new Orientation, view Information %@", self.showView);
}
...
- (void)deviceOrientationDidChange:(NSNotification *)notification {
    ...
    switch ([UIDevice currentDevice].orientation) {
        case 1:
        {//正
            _showView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
//            self.currentPlayerLayer.transform = CATransform3DMakeRotation(M_PI/2, 0, 0, 1);
            self.currentPlayerLayer.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
            self.navBar.frame = CGRectMake(0, 0, kScreenWidth, 49);
        }
            break;
        case 2:
        {//反
...
//        //        _showView.bounds = CGRectMake(0, 0, _showView.bounds.size.height, _showView.bounds.size.width);
//        _navBar.hidden = YES;
//        _showView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
//        self.currentPlayerLayer.transform = CATransform3DMakeRotation(M_PI/2, 0, 0, 1);
//        self.currentPlayerLayer.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
...
//    }
//    [_showView setTransform:rotationTransform];
//    if (animated) {
//        [UIView commitAnimations];
//    }

    
//    UIView *superview = _showView.superview;
//    if (!superview) {
//        return;
//    } else if ([superview isKindOfClass:[UIWindow class]]) {
//        [self setTransformForCurrentOrientation:YES];
//    } else {
////        _showView.bounds = _showView.superview.bounds;
////        _navBar.hidden = YES;
////        _showView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
////        self.currentPlayerLayer.transform = CATransform3DMakeRotation(M_PI/2, 0, 0, 1);
////        self.currentPlayerLayer.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
